...
{formtabbedpanel title='Location'}
    <fieldset>
    </fieldset>
{/formtabbedpanel}
...
{formtabbedpanel title='Dates'}
    ...
    <div class="z-formrow">
        {formlabel for="anniversary" __text="Anniversary"}
        {formdateinput id="anniversary" useSelectionMode=1 ifFormat='%e. %B %Y' dateformat='%e. %B %Y'}
    </div>
    </fieldset>
{/formtabbedpanel}
...
{formtabbedpanel title='Notes'}
    <fieldset>
        <div class="z-formrow">
            {formtextinput id="note" maxLength="64" textMode="multiline"}
        </div>
    </fieldset>
{/formtabbedpanel}
...
{formtabbedpanel title='Custom fields'}
    <fieldset>
    </fieldset>
{/formtabbedpanel}
